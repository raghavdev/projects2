...
set :deploy_to, "/var/www/sites/virtual/bluemarbledm-unfidev.metaltoad-sites.com"

# Set a different application name to avoid clobbering other databases
set :application, "bluemarbledm-unfidev"
